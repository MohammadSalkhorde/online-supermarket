# Generated by Django 5.0.3 on 2025-10-07 12:52
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_name', models.ImageField(blank=True, null=True, upload_to=utils.UploadFile.upload_to, verbose_name='تصویر برند')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image_name', models.ImageField(upload_to=utils.UploadFile.upload_to, verbose_name='تصویر کالا')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='product_gallery', to='products.product', verbose_name='کالا')),
            ],
            options={
                'verbose_name': 'تصویر',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_name', models.ImageField(blank=True, null=True, upload_to=utils.UploadFile.upload_to, verbose_name='تصویر گروه کالا')),
